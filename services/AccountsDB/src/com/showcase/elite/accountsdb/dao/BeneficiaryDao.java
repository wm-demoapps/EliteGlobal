...
/**
 * Specifies methods used to obtain and modify Beneficiary related information
 * which is stored in the database.
 */
@Repository("AccountsDB.BeneficiaryDao")
public class BeneficiaryDao extends WMGenericDaoImpl<Beneficiary, Integer> {
