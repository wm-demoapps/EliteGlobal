...
/**
 * Specifies methods used to obtain and modify AccountType related information
 * which is stored in the database.
 */
@Repository("AccountsDB.AccountTypeDao")
public class AccountTypeDao extends WMGenericDaoImpl<AccountType, Integer> {
