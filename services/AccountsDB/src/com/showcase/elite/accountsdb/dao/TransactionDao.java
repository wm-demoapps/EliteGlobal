...
/**
 * Specifies methods used to obtain and modify Transaction related information
 * which is stored in the database.
 */
@Repository("AccountsDB.TransactionDao")
public class TransactionDao extends WMGenericDaoImpl<Transaction, Integer> {
