...
/**
 * Specifies methods used to obtain and modify Corporate related information
 * which is stored in the database.
 */
@Repository("AccountsDB.CorporateDao")
public class CorporateDao extends WMGenericDaoImpl<Corporate, Integer> {
