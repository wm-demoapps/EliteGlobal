...
/**
 * Specifies methods used to obtain and modify CorporateUser related information
 * which is stored in the database.
 */
@Repository("AccountsDB.CorporateUserDao")
public class CorporateUserDao extends WMGenericDaoImpl<CorporateUser, Integer> {
